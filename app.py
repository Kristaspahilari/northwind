...
def products(supplier_id):
    ...
    supplier = database.get_products(supplier_id)
...
def categoryproducts(category_id):
    categories = database.get_categories()
    categoryproducts = database.get_categories_products(category_id)

    
    return render_template('categoryproducts.html', categoryproducts=categoryproducts, categories=categories)
